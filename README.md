...
> Answer:  The benefits of client-side routing is that you can build a single page application with navigation that doesnt have to refresh/re-render the page everytime a user selects a navigation element.
